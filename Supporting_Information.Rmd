...
\begin{equation}
G_{t|z} = a_{0} + a_{1}(\frac{1}{n_{t}}\sum_{i=1}^{n_{t}} (K^{*}_{\textrm{leaf},i|z} + \hat{\textrm{VPD}}^{*}_{i}) \textrm{LAI}^{*}_{doy|i}) + \epsilon_{t|z}
(\#eq:M5)
\end{equation}

\begin{equation}
G_{t|z} = a_{0} + a_{1}(\frac{1}{n_{t}}\sum_{i=1}^{n_{t}} K_{\textrm{leaf},i|z}^{*}\hat{\textrm{VPD}}_{i}^{*}\textrm{LAI}_{doy|i}^{*}) + \epsilon_{t|z}
(\#eq:M6)
\end{equation}
