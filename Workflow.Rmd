...
udi.calculator(splevel = "on", dryseason = "on", rsq.thresh = 0.5) ## udi is not calculated below this rsq.thresh
udi.calculator(splevel = "off", dryseason = "on", rsq.thresh = 0.5)
```

```{r Chunk 2.4.4, eval = TRUE}
source("R/4.7.summarising_udi_by_sp_size.R")
summarise.udi(splevel = "on", dryseason = "on", rsq.thresh = 0.7)
summarise.udi(splevel = "off", dryseason = "on", rsq.thresh = 0.7)
```
