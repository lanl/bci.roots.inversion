...
file.extension.base4 <- paste0(goodness.fit, "_", si.type, "_", n.ensembles, "_", growth.type, "_", growth.selection, "_", dbh.residuals, "_", intervals, "_dryseason_", dryseason, "_iso.subset_", iso.subset, "_root.selection_", root.selection)
...
#View(iso.udi)
write.csv(iso.udi, file.path(paste0("results/iso.udi_cor", file.extension.base4, ".csv", sep = "")), row.names = FALSE)


file.path.udi <- file.path("figures/UDI_confidence", growth.type, growth.selection, paste0("dbh.residuals_", dbh.residuals), paste0("dryssn_", dryseason, "_root.selection_", root.selection))
