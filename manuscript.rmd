...
(\#eq:erd)
\end{equation} 
where $H$ $\in$ {1, .., 100}, refer to the 100 hydrological realisations and $Z$ $\in$ 0.5, {`r paste(soil.depths[8:length(soil.depths)], collapse=", ")`} m, covering the range of soil depths in ELM-FATES after above parametarision [@Chonggang, Depths 0.21, 0.37 and 0.62 were all labelled as 0.5 m for model evaluation. How do I explain that? Do they need to be retained as their original depths?].
